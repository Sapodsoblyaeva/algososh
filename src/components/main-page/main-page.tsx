  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        ...
        <Link className={styles.link} to="/sorting" data-testid="sorting-card">
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link className={styles.link} to="/stack" data-testid="stack-card">
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link className={styles.link} to="/queue" data-testid="queue-card">
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link className={styles.link} to="/list" data-testid="list-card">
